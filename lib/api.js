...
import { isValidJson, encrypt, decrypt, storageGet, storageSet, logThis } from './helpers.js';
...
// !!! UPDATE THIS ONCE DONE WITH DEVELOPMENT !!!!

export const STASH_GIST_FILENAME = 'stash-dev.json';
