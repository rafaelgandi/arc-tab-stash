...
import { isValidJson, encrypt, decrypt, storageGet, storageSet, logThis, sendErrorToast, handleError, isInDevMode } from './helpers.js';
...
export async function getGitCredsSaved() {
    ...
    const tokenEncrypted = await encrypt(gitToken);
    return {
        token: gitToken,
        gist: gistLink,
